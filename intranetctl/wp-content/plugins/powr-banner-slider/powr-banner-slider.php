<?php
    ...
    */
    ...
    function powr_banner_slider_options() {
      ...
      echo '<iframe id="powr-banner-slider" src="https://www.powr.io/wp-create/banner-slider" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight; if(document.getElementById("wpadminbar")){ht -= document.getElementById("wpadminbar").offsetHeight;}';
      echo 'var iframe = document.getElementById("powr-banner-slider"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
