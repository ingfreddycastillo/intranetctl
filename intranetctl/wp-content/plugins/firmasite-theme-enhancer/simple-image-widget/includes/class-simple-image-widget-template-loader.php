 ...
 * @author  Gary Jones
 */
class FirmaSite_Simple_Image_Widget_Template_Loader {
	/**
	 ...
	 * @type string
	 */
	protected $theme_template_directory = "firmasite-theme-enhancer";
	 ...
	 * @since 4.0.0
	 *
	 * @uses FirmaSite_Simple_Image_Widget_Template_Loader::get_template_possble_parts()
	 *     Create file names of templates.
	 * @uses FirmaSite_Simple_Image_Widget_Template_Loader::locate_template() Retrieve the
	 ...
	 * @since 4.0.0
	 *
	 * @uses FirmaSite_Simple_Image_Widget_Template_Loader::get_template_paths() Return a
