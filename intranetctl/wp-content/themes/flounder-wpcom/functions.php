...
function flounder_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'flounder_custom_background_args', array(
 ...
 */
function flounder_admin_scripts( $hook_suffix ) {
...
add_action( 'admin_enqueue_scripts', 'flounder_admin_scripts' );
